...
public final class Nodelist {
    ...
    public Collection<NodeHost> getActive() {
        List<NodeHost> nodes = new ArrayList<>(activeNodes);
        //nodes.removeAll(getUpgrade());
        nodes.removeAll(getFree());
        return nodes;
    }
    ...
    public Collection<NodeHost> getActiveAux() {
        ...
        ret.remove(master);
        //ret.removeAll(getUpgrade());
        ret.removeAll(getFree());
    ...
    public Collection<NodeHost> getUpgrade() {
        ...
        for (NodeHost nn:allNodes) {
            System.out.println("NODE: " + nn.host + " is set to " + nn.getState().toString());
    ...
    public void activate(Collection<NodeHost> nodes) {
    ...
    public void remove(Collection<NodeHost> nodes) {
    ...
    public void maybeSwitchMaster(List<NodeHost> nextActive) {
     ...
     * @return
     */
    public List<NodeHost> getNextActive(Collection<NodeHost> omitList) {
     ...
     *
     * This is the inverse of {@link #hintDifferentGroups(Collection)}
