...
public class NodelistBuilder {
    ...
    public NodelistBuilder(Collection<NodeHost> initialNodes, int numGroups, GroupPolicy groupPolicy, String upgradeVersion, int active) {
        ...
        innerList = new Nodelist(new ArrayList<NodeHost>(initialNodes), active, numGroups, upgradeVersion);
    }

    public NodelistBuilder(Collection<NodeHost> initialNodes) {
        this(initialNodes, 1, GroupPolicy.SEPARATE, "", initialNodes.size());
    }

    public NodelistBuilder(Collection<NodeHost> initialNodes, int numGroups, String upgradeVersion, int active) {
        this(initialNodes, numGroups, GroupPolicy.SEPARATE, upgradeVersion, active);
    }
