...
import com.couchbase.utils.remote.SimpleCommand;
...
public class ClusterConfigureUtils {
    ...
    void setupSecondaryBucket(CouchbaseAdmin adm) throws RestApiException {
        BucketConfig bConfig = new BucketConfig(inputParameters.getSecBucketName());
        logger.info("secBucketType"+inputParameters.getSecBucketType());
        bConfig.bucketType = bConfig.getbucketType(inputParameters.getSecBucketType());;
        bConfig.evictionPolicy = bConfig.getevictionPolicy(inputParameters.getBucketEphemeralEvictionPolicy());
        bConfig.ramQuotaMB = inputParameters.getbucketRamSize();;
    ...
    public BucketConfig buildMainBucketOptions() {
        ...
        logger.info("bucketType"+inputParameters.getbucketType());
